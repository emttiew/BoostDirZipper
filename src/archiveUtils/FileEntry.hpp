...
namespace archive_utils
{
    ...
    public:
        ...
        explicit FileEntry(size_t const dataSize, std::string const &path) : Entry(EntryType::File, dataSize), directory(path, EntryType::File) {}

        void writeMetaData(io::filtering_ostream &out);
        void writeSome(io::filtering_ostream &out, DataBufferType const& buffer, std::streamsize const streamSize);
